...
const routes: Routes = [
  ...
  {path: 'booksInfo', component: ShowBooksComponent, data: {roles: ['admin']}, canActivate: [AuthGuard]},
  {path: 'showUsers', component: ShowUsersComponent, data: {roles: ['admin']}, canActivate: [AuthGuard]},
  {path: 'showRequests', component: ShowRequestsComponent, data: {roles: ['admin'], canActivate: [AuthGuard]}},
  {path: 'showIssuedBooks', component: IssuedBooksComponent, data: {roles: ['admin']}, canActivate: [AuthGuard]},
  {path: 'bookIssue', component: IssueBooksComponent, data: {roles: ['admin']}, canActivate: [AuthGuard]},
